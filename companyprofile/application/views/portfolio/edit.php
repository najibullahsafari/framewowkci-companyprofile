      ...
      <div class="col-lg-10">
        ...
        <div class="form-group">
            ...
            <select class="form-control col-sm-10" name="kategori" id="kategori">
              <option selected value="<?= $portfolio['kategori']; ?>"><?= $portfolio['kategori']; ?></option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="nama" name="nama" placeholder="Input nama" value="<?= $portfolio['nama']; ?>">
